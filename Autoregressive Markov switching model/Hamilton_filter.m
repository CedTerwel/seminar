function [ filteredxi , predictedxi ] = Hamilton_filter(p11,p22,mu,beta,sigma,y)
...
for t = 1:T
    ...
    % UPDATE STEP
    likelihood(:,t)   = [ normpdf(y(1,t), mu(1) + beta(1) * y(1,t-1), sigma(1)) ; my_pdf(y(1,t), mu(2) + beta(2) * y(1,t-1), sigma(2)) ];
